...
add_scene(
  ...
  text = "Layal is passionate about languages, whether living, dead or computer-based. After graduating from high school with a focus on languages and philosophy, she went on to study business administration and political economy, during which time she developed a passion for statistics and econometrics. After working in the Swiss federal administration as an econometrician, she decided to concentrate on data work and became a data scientist. Thanks to her IT and data management skills, she is mainly responsible for maintaining the production company's IT solutions and finances.",
