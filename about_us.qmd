...
add_card <- function(src, title, subtitle, text, url, link_text, img_alt) {
  lines <- c(
    '<div class="g-col-18 g-col-md-9 g-col-xl-18">',
...
add_card(
  ...
  title = "Rani", 
  subtitle = "Creation",
  text = "Rani embarked on his discovery of filmmaking by studying cinema in Seoul, South Korea. 
  These days, he's working as a freelance translator. 
  When he's not lost in translation, you might catch him casually flipping through literary and philosophical works, trying in vain to make sense of them, or tinkering on the piano or on his computer, making up music – or noise, depending on who you ask. And when the day winds down, he's all about gaming into the wee hours of the night.
The discovery of new experiences and impressions through diverse art forms and media is what interests Rani and what he wishes to convey through his own works.",
